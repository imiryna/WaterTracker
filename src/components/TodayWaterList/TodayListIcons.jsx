...
export const TodayListIcons = ({ id, width, height }) => {
  let svg;
  switch (id) {
    case 'delete-icon': {
      svg = (
    ...
    case 'minus-icon': {
      svg = (
        ...
        >
          <title>minus</title>
          <path d="M224 512c0-17.673 14.327-32 32-32v0h512c17.673 0 32 14.327 32 32s-14.327 32-32 32v0h-512c-17.673 0-32-14.327-32-32v0z"></path>
        </svg>
      );
      break;
    }
